...
def parser_args():
    ...
    parser.add_argument('--relation', type=str, default="./data/data/NYT/rel2id.json", help='specify the relation path')
    parser.add_argument('--train_file', type=str,default="./data/data/NYT/train_triples.json", help='specify the train path')
    parser.add_argument('--val_file', type=str,default="./data/data/NYT/dev_triples.json", help='specify the dev path')
    parser.add_argument('--test_path', type=str,default="./data/data/NYT/test_triples.json", help='specify the test path')
